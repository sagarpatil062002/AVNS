...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
    ...
    if (!empty($oem_name)) { 
        ...
        $successMessage = "OEM name cannot be empty."; 
    } 
} 
?>
    ...
    <style>
        ...
        * {
        ...
        .container {
            ...
            width: 50%;
            margin-left: 450px; /* Space for the sidebar */
            padding: 30px;
            border-radius: 6px;
...
<div class="container">
    <header>Add New OEM</header>
    <form method="POST">
        <div class="form-group">
            <label class="form-label">OEM Name</label>
            <input type="text" name="oem_name" class="form-input" required>
        </div>
        <button type="submit">Add OEM</button>
