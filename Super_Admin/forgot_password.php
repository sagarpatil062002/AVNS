...
// Include Composer autoload or manually include PHPMailer files
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'sagarpatil062002@gmail.com'; // Replace with your email
            $mail->Password = 'tleeljiyjxxtfuxv'; // Replace with your email app password
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;

            // Email settings
            $mail->setFrom('sagarpatil062002@gmail.com', 'AVNS Technosoft');
            $mail->addAddress($mailId);
            $mail->isHTML(true);

            $resetLink = "http://localhost/AVNS/super_admin/reset_password.php?token=" . urlencode($token);
