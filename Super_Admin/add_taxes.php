...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($tax_name) && !empty($tax_percentage)) {
        ...
        $errorMessage = "Tax name and percentage cannot be empty.";
    }
}
?>
    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Add New Tax Rate</h1>
                <p class="card-subtitle">Configure tax rates for your system</p>
            </div>
            
            <form method="POST">
                <div class="form-group">
                    <label for="tax_name" class="form-label">Tax Name</label>
                    <input type="text" id="tax_name" name="tax_name" class="form-control" required placeholder="e.g. VAT, GST, Sales Tax">
                    <i class="uil uil-label-alt input-icon"></i>
                </div>
                
                <div class="form-group">
                    <label for="tax_percentage" class="form-label">Tax Percentage</label>
                    <input type="number" id="tax_percentage" name="tax_percentage" class="form-control" required placeholder="0.00" step="0.01" min="0" max="100">
                    <span class="percentage-symbol">%</span>
                </div>
                
                <button type="submit" class="btn btn-primary">
                    <i class="uil uil-plus-circle icon"></i> Add Tax Rate
                </button>
